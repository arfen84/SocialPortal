...
namespace SocialPortal.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public async Task<IActionResult> ChangePassword(IFormCollection collection)
        {
            ...
            string oldPass = Convert.ToString(collection["passViewModel.OldPassword"]);
            string newPass = Convert.ToString(collection["passViewModel.NewPassword"]);

            var changePasswordResult = await _userManager.ChangePasswordAsync(user, oldPass , newPass);
            if (!changePasswordResult.Succeeded)
            {
                AddErrors(changePasswordResult);
                RedirectToAction("Profil", "Home", new { area = "Admin" });
            }
            ...
            return RedirectToAction("Profil", "Home", new { area = "Admin" });
        ...
        private string GenerateQrCodeUri(string email, string unformattedKey)
        {
            return string.Format(
                ...
                _urlEncoder.Encode("SocialPortal"),
